...
parser.add_argument('--multi_heads', type=int, default=2, 
                    help='(int, default 2)')                   
...
# Seurat related
parser.add_argument('--load_from_seurat', action='store_true', default=False, 
                    help='(boolean, default False) If true, will load from seurat')
parser.add_argument('--seurat_obj_path', type=str, default=None, 
                    help='(boolean, default False) If true, will load from seurat')
